...
- To proceed let's recall the concept of random sampling.
\vspace{10pt}
  \pause

- Can you recall what a  sample is? A random sample?
\vspace{10pt}
  \pause
...
\footnotesize
**\textcolor{blue}{Instruction:}** \textcolor{blue}{Work with the classmate on your left for 3 minutes to figure out the solution.}
...
- Download the Jupyter notebook **"HW_law_of_large_numbers.ipynb"** from our course's GitHub repository.

\vspace{15pt}

- Work through the notebook, answer the questions, and submit your completed assignment by the start of next week's class.
